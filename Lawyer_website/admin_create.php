...
<i style="color:blue; font-size:30px;"><h2>Create Admin</h2></i>
</center>
...
<div class="container">
  <form action="admin_process.php?email=<?php echo $_GET['email'];?>" method="post" enctype="multipart/form-data">
    <div class="row">
      ...
      <div class="col-75">
        <input style="border-radius:20px;" type="text" id="fname" name="admin_name" placeholder="YOUR ADMIN NAME.." required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
      <input style="border-radius:20px;" type="email" id="lname" name="admin_email" placeholder="YOUR ADMIN EMAIL.." required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <i><b><label for="lname"style="color:red; font-size: 30px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspADMIN PASSWORD :</label></i></b>
      </div>
      <div class="col-75">
      <input style="border-radius:20px;" type="password" id="lname" name="admin_password" placeholder="YOUR ADMIN PASSWORD.." required>
      </div>
    </div>
    <br>
    <center>
    <div class="row" >
      <input style="border-radius:20px;" type="submit" value="CREATE" name="login">
    </div>
    </center>
  </form>
</div>
