  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
        <a class="nav-link linkone" href="admin_home.php?email=<?php echo $_GET['email'];  ?>">Home<span class=""></span></a>
          <!-- <a class="nav-link linkone" href="customer_home.php?email=<?php echo $_GET['email']; ?>">Home<span class=""></span></a>  -->
        </li>
        ...
        <a class="dropdown-item" href="customer_appoint.php?email=<?php echo $_GET['email']; ?>">Customer Appointment</a>      
         <!-- <div class="dropdown-divider"></div> -->
         <a class="dropdown-item" href="lawyeradmin_appoint.php?email=<?php echo $_GET['email']; ?>">lawyer Appointment</a>   
       </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="Admin_detail.php?email=<?php echo $_GET['email']; ?>">Admin Detail</a>
        <a class="dropdown-item" href="admin_create_appoint.php?email=<?php echo $_GET['email']; ?>">Admin Create</a>
         </li>


        <li class="nav-item">
        <a class="nav-link" href="Customer_detail.php?email=<?php echo $_GET['email']; ?>">Customer Detail</a>      
        </li>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a href="#">Name</a>
        <a href="customer_profile.php?email=<?php echo $_GET['email']; ?>">My Profile profile</a>
        <a href="logout.php">Logout</a>
        </li>
        
        <li class="nav-item">
        <a class="nav-link" href="#">|&nbsp<i class="fa fa-phone" aria-hidden="true"></i>&nbsp123 456 7890</a>
...
<div class="item">
            ...
            <div>
                <h3><?php echo $arr['lawyer_experties']; ?></h3>
            </div>
            <div class="p">
            ...
            <div class="">
              <center>
            <a href="#." class="readmore btn btn-success">Read More</a>
            </center>
