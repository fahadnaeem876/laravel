    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <!-- <li><a href="services.html">Service</a></li> -->
         ...
         <li class="dropdown"><a href="#"><img style="border-radius:50%;" src="<?php echo $data['customer_img']; ?>" name="image_product_image" height="40px" width="50px"><span class="caret"></span></a>
          <!-- dropdown start -->
          <ul class="dropdown-menu">
            <li><a href="#"><?php echo $data['customer_name']; ?></a></li>
