...
if(isset($_POST['login'])){
    ...
    // $lawyer_experties = $_POST['lawyer_experties'];
    // $lawyer_qualification = $_POST['lawyer_qualification'];
...
if($fileerror == 0){
 ...
 $sql = "UPDATE lawyers SET lawyer_name='$lawyer_name', lawyer_email='$lawyer_email', lawyer_password='$lawyer_password',
 lawyer_address='$lawyer_address', lawyer_phone='$lawyer_phone', lawyer_experties='$lawyer_experties',
  lawyer_qualification='$lawyer_qualification', gender='$gender', services='$lawyer_service'
  ,detail='$lawyer_detail' ,lawyer_img='$destfile' where lawyer_email='$email'";
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="view_appointment.php?email=<?php echo $_GET['email'];?>" class="nav-item nav-link">View Appointment</a>
                        </div>
...
<div id="container">
<br>
  <h1>&bull; UPDATE PROFILE &bull;</h1>
  <div class="underline">
  </div>
    <form method="post" id="contact_form" enctype="multipart/form-data">
    <div class="name">
    <b><label for="name">NAME :</label></b>
      <input type="text"  name="lawyer_name" value="<?php echo $data1 ['lawyer_name']?>" required>
    </div>
    <div class="email">
    <b><label for="email">EMAIL :</label></b>
      <input type="email" name="lawyer_email" value="<?php echo $data1 ['lawyer_email']?>" required>
    </div>
    <div class="name">
    <b><label for="email">PASSWORD :</label></b>
      <input type="password"  name="lawyer_password" value="<?php echo $data1 ['lawyer_password']?>" required>
    </div>
    <div class="email">
    <b><label for="email">ADDRESS :</label></b>
      <input type="text"  name="lawyer_address" value="<?php echo $data1 ['lawyer_address']?>" required>
    </div>
    <div class="name">
    <b><label for="email">PHONE :</label></b>
      <input type="number"  name="lawyer_phone" value="<?php echo $data1 ['lawyer_phone']?>" required>
    </div>
    ...
    <b><label for="email">QUALIFICATION :</label></b>
      <input type="text"  name="lawyer_qualification" value="<?php echo $data1 ['lawyer_qualification']?>" required>
    </div>

    <div class="name">
    <b><label for="email">SERVICE :</label></b>
      <input type="text"  name="service" value="<?php echo $data1 ['services']?>">
    </div>
    ...
    <b><label>EXPERTIES :</label></b>
      <select name="lawyer_experties" value="<?php echo $data1 ['lawyer_experties']?>" required>
    ...
    <div class="name">
    <b><label for="email">Gender  : &nbsp</label></b>
    <input type="radio" id="lname" name="gender" value="Male" required>Male
        <input type="radio" id="lname" name="gender" value="Female" required>Female
          </div>

          <div class="email">
          <b><label for="email">Profile Picture  : &nbsp</label></b>
		    <input type="file" 
		           name="image">
		  </div>
   ...
   <center>
    <div class="submit">
         <input style="border-radius:20px;"id="form_button"  type="submit" value="UPDATE" name="login">
    </div>
    </center>
  </form>
</div>
