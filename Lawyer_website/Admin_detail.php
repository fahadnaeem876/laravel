...
<tr>
    ...
    <td><?php echo $arr['admin_email']; ?></td>
    <td><?php echo $arr['admin_password']; ?></td>
    <td><a href="update_admin.php?admin_id=<?php echo $arr['admin_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class="fa fa-edit" style="font-size:24px; color:green;"></i></a></td>
    <td><a href="delete_admin.php?admin_id=<?php echo $arr['admin_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class="fa fa-close" style="font-size:24px; color:red;"></i></a></td>
    </tr>
  </tbody>
